      ...
      <div class="login-box">
        ...
        <div class="login-value">
          ...
          <div class="verificationCode">
            <el-button @click="getVerificationCode" :disabled="isEnabled">{{
              show ? "发送验证码" : count + "s后可发送！"
            }}</el-button>
            {{ sentEmaliMsg }}
          </div>
          <el-input
...
export default {
  ...
  methods: {
    tipsUser() {
      ...
      if (
        this.userData.username.length > 6 &&
        reg.test(this.userData.username)
      ) {
    ...
    tipsEmail() {
      ...
      if (this.userData.email.length > 8 && reg.test(this.userData.email)) {
    ...
    commitData() {
      ...
      if (
        this.siSentEmali.unR &&
        this.siSentEmali.pdR &&
        this.siSentEmali.rePdR &&
        this.siSentEmali.emR &&
